...
for kpart in range(3):
    ...
    with tf.Session() as sess:
        ...
        np.savetxt('7wts/'+str(kpart+1)+'/1.txt',wt1,delimiter='\t',fmt='%f')
        np.savetxt('7wts/'+str(kpart+1)+'/2.txt',wt2,delimiter='\t',fmt='%f')
        np.savetxt('7wts/'+str(kpart+1)+'/3.txt',wt3,delimiter='\t',fmt='%f')
        np.savetxt('7wts/'+str(kpart+1)+'/4.txt',wt4,delimiter='\t',fmt='%f')
        np.savetxt('7wts/'+str(kpart+1)+'/5.txt',wt5,delimiter='\t',fmt='%f')
	np.savetxt('7wts/'+str(kpart+1)+'/6.txt',wt6,delimiter='\t',fmt='%f')
	np.savetxt('7wts/'+str(kpart+1)+'/7.txt',wt7,delimiter='\t',fmt='%f')
	np.savetxt('7wts/'+str(kpart+1)+'/8.txt',wt8,delimiter='\t',fmt='%f')
	...
	np.savetxt('7bs/'+str(kpart+1)+'/1.txt',bs1,delimiter='\t',fmt='%f')
	np.savetxt('7bs/'+str(kpart+1)+'/2.txt',bs2,delimiter='\t',fmt='%f')
	np.savetxt('7bs/'+str(kpart+1)+'/3.txt',bs3,delimiter='\t',fmt='%f')
 	np.savetxt('7bs/'+str(kpart+1)+'/4.txt',bs4,delimiter='\t',fmt='%f')
	np.savetxt('7bs/'+str(kpart+1)+'/5.txt',bs5,delimiter='\t',fmt='%f')
	np.savetxt('7bs/'+str(kpart+1)+'/6.txt',bs6,delimiter='\t',fmt='%f')
	np.savetxt('7bs/'+str(kpart+1)+'/7.txt',bs7,delimiter='\t',fmt='%f')
	np.savetxt('7bs/'+str(kpart+1)+'/8.txt',bs8,delimiter='\t',fmt='%f')
