...
for kpart in range(3):
    ...
    with tf.Session() as sess:
        ...
        np.savetxt('mainwts2/'+str(kpart)+'/1.txt',wt1,delimiter='\t',fmt='%f')
        np.savetxt('mainwts2/'+str(kpart)+'/2.txt',wt2,delimiter='\t',fmt='%f')
        np.savetxt('mainwts2/'+str(kpart)+'/3.txt',wt3,delimiter='\t',fmt='%f')
        np.savetxt('mainwts2/'+str(kpart)+'/4.txt',wt4,delimiter='\t',fmt='%f')
        np.savetxt('mainwts2/'+str(kpart)+'/5.txt',wt5,delimiter='\t',fmt='%f')
        np.savetxt('mainwts2/'+str(kpart)+'/6.txt',wt6,delimiter='\t',fmt='%f')
        ...
        np.savetxt('mainbs2/'+str(kpart)+'/1.txt',bs1,delimiter='\t',fmt='%f')
        np.savetxt('mainbs2/'+str(kpart)+'/2.txt',bs2,delimiter='\t',fmt='%f')
        np.savetxt('mainbs2/'+str(kpart)+'/3.txt',bs3,delimiter='\t',fmt='%f')
        np.savetxt('mainbs2/'+str(kpart)+'/4.txt',bs4,delimiter='\t',fmt='%f')
        np.savetxt('mainbs2/'+str(kpart)+'/5.txt',bs5,delimiter='\t',fmt='%f')
        np.savetxt('mainbs2/'+str(kpart)+'/6.txt',bs6,delimiter='\t',fmt='%f')
