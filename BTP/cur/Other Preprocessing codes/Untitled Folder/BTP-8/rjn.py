...
y1=[]
y2=[]
strain = [0 for i in range(7)]
stest = [0 for i in range(7)]
for i in range(7):
...
with tf.Session() as sess:
    ...
    teval = [0 for i in range(7)]
    teval3 = [0 for i in range(7)]
    ...
    print act
    print clt3
    tsteval = [0 for i in range(7)]
    tsteval3 = [0 for i in range(7)]
